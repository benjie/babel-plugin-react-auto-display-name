...
exports['default'] = function (_ref) {
  ...
  function buildDisplayName(filename) {
    return filename.replace(/^.*!([^!]+)$/, "$1") // Remove webpack stuff
    .replace(/(.*)components/, '').replace(/^\//, '').replace(/\.[a-z]+$/, '') // Remove extension
  ...
  return new Plugin("react-auto-display-name", {
    ...
    visitor: {
      ...
      "AssignmentExpression|Property|VariableDeclarator": function AssignmentExpressionPropertyVariableDeclarator(node, parent, scope, file) {
